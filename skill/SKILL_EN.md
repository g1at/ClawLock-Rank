...
name: clawlock-rank
description: >
  ClawLockRank — a leaderboard upload skill built from ClawLock inspection results.
  ...
  clawlock_rank:
    ...
    requires:
      ...
      bins:
        ...
        - python
    note: >
      The default leaderboard backend URL is stored in skill/config.json.
      The scan runs locally first, and only the allowlisted fields are uploaded after explicit user confirmation.
---
